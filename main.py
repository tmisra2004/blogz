...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://127.0.0.1:3306/blogz'
...
# User class model and constructor
class User(db.Model):
    id = db.Column(db.Integer, primary_key=True)
...
def signup():
    if request.method == 'POST':
        ...
        # If all requirements met, continue to creating session with new username and password.
